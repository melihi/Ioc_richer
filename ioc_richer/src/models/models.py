...
class Ioc_model(Base):
    ...
    ioc_threatminer_av_detect = Column(JSONB, index=True)
    ioc_threatminer_host = Column(JSONB, index=True)
    ioc_threatminer_domain = Column(JSONB, index=True)
    ioc_threatminer_report = Column(JSONB, index=True)
    ioc_threatminer_ip_related = Column(JSONB, index=True)
    ioc_threatfox = Column(JSONB, index=True)
    ioc_malshare = Column(JSONB, index=True)
    ioc_greynoise = Column(JSONB, index=True)
    ioc_googleads = Column(JSONB, index=True)
    ioc_malwarebazaar = Column(JSONB, index=True)
