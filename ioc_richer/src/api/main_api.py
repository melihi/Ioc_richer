...
async def add_ioc(
    ...
    test = BaseIoc(
        ...
        ioc_threatminer_av_detect=json.dumps("[]"),
        ioc_threatminer_host=json.dumps("[]"),
        ioc_threatminer_domain=json.dumps("[]"),
        ioc_threatminer_report=json.dumps("[]"),
        ioc_threatminer_ip_related=json.dumps("[]"),
        ioc_threatfox=json.dumps("[]"),
        ioc_malshare=json.dumps("[]"),
        ioc_greynoise=json.dumps("[]"),
        ioc_googleads=json.dumps("[]"),
        ioc_malwarebazaar=json.dumps("[]"),
